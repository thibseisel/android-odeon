...
/**
 * Define extra metadata keys that are recognized by Android Auto
 * to apply custom style when displaying media items.
 *
 * More info: [Build media apps for cars - Apply content styling](https://developer.android.com/training/cars/media#default-content-style)
 */
