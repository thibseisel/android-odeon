...
import fr.nihilus.music.media.utils.loadResourceAsBitmap
...
@Inject constructor(private val service: MusicService) {
    ...
    private val pauseAction = NotificationCompat.Action(
        ...
        service.getString(R.string.abc_action_pause),
    ...
    private val playAction = NotificationCompat.Action(
        ...
        service.getString(R.string.abc_action_play),
        MediaButtonReceiver.buildMediaButtonPendingIntent(
            service,
    ...
    private val previousAction = NotificationCompat.Action(
        ...
        service.getString(R.string.abc_action_previous),
        MediaButtonReceiver.buildMediaButtonPendingIntent(
            service,
    ...
    private val nextAction = NotificationCompat.Action(
        ...
        service.getString(R.string.abc_action_next),
        MediaButtonReceiver.buildMediaButtonPendingIntent(
            service,
    ...
    private val defaultLargeIcon = loadResourceAsBitmap(
        service, R.drawable.abc_ic_default_icon,
        ICON_SIZE, ICON_SIZE
    )
    ...
    private fun createChannel() {
        if (notificationManager.getNotificationChannel(CHANNEL_ID) == null) {
            ...
            val name = service.getString(R.string.abc_channel_mediasession)
            val channelDescription = service.getString(R.string.abc_channel_mediasession_description)
    ...
    private fun configureNotification(
        ...
        builder.setSmallIcon(if (isPlaying) R.drawable.abc_notif_play_arrow else R.drawable.abc_notif_pause)
