...
public class ListFragment extends Fragment {
    ...
    static final
    @IdRes
    int INTERNAL_PROGRESS_CONTAINER_ID = 0x00ff0002;
    static final
    @IdRes
    int INTERNAL_LIST_CONTAINER_ID = 0x00ff0003;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View emptyView = onCreateEmptyView(inflater, lframe, savedInstanceState);
     ...
     *
     * @param list     The ListView where the click happened
